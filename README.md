...
> Конечно, размещать TODO в доке это моветон, но тем не менее, пока идет начальная разработка, считаю это допустимым.

Структура папок еще может поменяться. Например, мы объединим все схемы в одну папку. Или засунем их в папки ресурсов. Последнее может быть некорректным с точки зрения работы с БД, но может оказаться эффективным для программирования и слабой связанности компонентов. Особенно используя Prisma и GraphQL мы можем легко управлять ресурсами одних таблиц из других таблиц.

- протестировать другие варианты взаимодействия Prisma и GraphQL
- попробовать генерацию схемы GraphQL из схемы Prisma
- исключить Apollo, связав Prisma и GraphQL без него
- или исключить Express, назначив пути в Apollo
